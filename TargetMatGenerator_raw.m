function targetmat = TargetMatGenerator_raw(name, varargin)
%   Only generate matrix
%   {name, *para} = {{'gauss', m, n, k, f},
%                    {'hilbert', m, n},
%                    {'lapkernel', ns, nt, kernel, helmholtz, plot},
%                    {'gspd',m,k,f}
