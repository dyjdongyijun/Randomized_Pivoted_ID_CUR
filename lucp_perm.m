function [L,U,p,q] = lucp_perm(A,tol,pm_opt)
% Nick Henderson (2020). LU factorization with complete pivoting. 
%   https://www.mathworks.com/matlabcentral/fileexchange/27249-lu-factorization-with-complete-pivoting, 
